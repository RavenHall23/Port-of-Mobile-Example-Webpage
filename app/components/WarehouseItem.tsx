...
export function WarehouseItem({ warehouse, onClick, isSelected, utilization }: WarehouseItemProps) {
  const getUtilizationColor = (percentage: number) => {
    if (percentage <= 25) return 'from-green-500/90 to-emerald-500/90 dark:from-green-400/90 dark:to-emerald-400/90'
    if (percentage <= 50) return 'from-yellow-500/90 to-amber-500/90 dark:from-yellow-400/90 dark:to-amber-400/90'
    if (percentage <= 75) return 'from-orange-500/90 to-amber-600/90 dark:from-orange-400/90 dark:to-amber-500/90'
  ...
  const getRingColor = (percentage: number) => {
    if (percentage <= 25) return 'ring-emerald-500/30 dark:ring-emerald-400/30'
    if (percentage <= 50) return 'ring-amber-500/30 dark:ring-amber-400/30'
    if (percentage <= 75) return 'ring-orange-500/30 dark:ring-orange-400/30'
